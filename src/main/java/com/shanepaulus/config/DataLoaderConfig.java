...
public class DataLoaderConfig {
    ...
    public ForkJoinPool dataLoaderThreadPool() {
        var workerThreadFactory = new DataLoaderForkJoinWorkerThreadFactory();
        return new ForkJoinPool(THREAD_COUNT, workerThreadFactory, null, false);
    }

    private static class DataLoaderForkJoinWorkerThreadFactory implements ForkJoinPool.ForkJoinWorkerThreadFactory {
